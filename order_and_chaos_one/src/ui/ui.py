from order_and_chaos_one.src.board.board_text_file import TextFileBoard
from order_and_chaos_one.src.domain.computer import Computer
...
class Ui:
    ...
    def gameplay(board):
        ...
        while not board.draw():
            ...
            print(board)
            print(f"Human:({move}), AI:({i},{j},{symbol})")
            if board.win():
                print()
                print("Order WINS!")
                print()
